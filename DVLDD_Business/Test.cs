...
namespace DVLD_Business
{
    public class Test
    {
        ...
        public clsAppointments TestAppointmentInfo { set; get; }
...

        {
            ...
            this.TestAppointmentInfo = clsAppointments.Find(TestAppointmentID);
        ...
        public static Test FindLastTestPerPersonAndLicenseClass
            (int PersonID, int LicenseClassID, clsTestTypes.eTestType TestTypeID)
        {
            int TestID = -1;
            int TestAppointmentID = -1;
            bool TestResult = false; string Notes = ""; int CreatedByUserID = -1;
